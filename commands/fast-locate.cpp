...
namespace {
    ...
    InputParams parse_input_arguments(int argc, char *argv[]) {
        ...
        auto cli =
            ...
            clara::Opt(params.prefix, "prefix")["--prefix"]("Path prefix which will be appended to the output paths.") |
            clara::Opt(dbs, "database")["-d"]["--database"](
                "The file information database. This database is generated by fast-updatedb command.") |
